...
def main():
    q = YelpQueryConcurrent()
    query_list = []
    query_list.append(((34.1561, -118.1319), 40000, 0, "restaurants, All", 20))
    query_list.append(((34.1561, -118.1319), 40000, -118.1219, 0, "education, All", 20))
    query_list.append(((34.1561, -118.1319), 40000, -118.1219, 0, "arts, All", 20))
    
    response = q.query_by_bounds(query_list)
